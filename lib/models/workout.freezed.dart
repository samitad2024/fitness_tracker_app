...
class _$WorkoutImpl implements _Workout {
  ...
  @override
  String toString() {
    return 'Workout(id: $id, name: $name, weight: $weight, reps: $reps, sets: $sets, type: $type, createdAt: $createdAt, isCompleted: $isCompleted, completedAt: $completedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, weight, reps, sets,
      type, createdAt, isCompleted, completedAt);
